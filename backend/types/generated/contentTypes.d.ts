...
export interface ApiBusinessInquiryBusinessInquiry
  ...
  info: {
    displayName: 'Business Inquiry';
    pluralName: 'business-inquiries';
    singularName: 'business-inquiry';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    students_size: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFeatureNotificationFeatureNotification
  extends Struct.CollectionTypeSchema {
  collectionName: 'feature_notifications';
  info: {
    displayName: 'Feature Notification';
    pluralName: 'feature-notifications';
    singularName: 'feature-notification';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::feature-notification.feature-notification'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFullMockTestAttemptFullMockTestAttempt
  ...
  info: {
    displayName: 'Full Mock Test Attempt';
    pluralName: 'full-mock-test-attempts';
    singularName: 'full-mock-test-attempt';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    listening_score: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    writing_score: Schema.Attribute.Decimal;
  };
}
...
export interface ApiListeningSectionListeningSection
  ...
  info: {
    displayName: 'Listening Section';
    pluralName: 'listening-sections';
    singularName: 'listening-section';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::listening-section.listening-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    questions: Schema.Attribute.Relation<'oneToMany', 'api::question.question'>;
    section_number: Schema.Attribute.Integer & Schema.Attribute.Required;
    test: Schema.Attribute.Relation<'manyToOne', 'api::test.test'>;
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    listening_section: Schema.Attribute.Relation<
      'manyToOne',
      'api::listening-section.listening-section'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    metadata: Schema.Attribute.JSON;
    module_type: Schema.Attribute.Enumeration<['listening', 'reading']> &
      Schema.Attribute.Required;
    options: Schema.Attribute.JSON;
    points: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiReadingPassageReadingPassage
  extends Struct.CollectionTypeSchema {
  collectionName: 'reading_passages';
  info: {
    displayName: 'Reading Passage';
    pluralName: 'reading-passages';
    singularName: 'reading-passage';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiSpeakingTopicSpeakingTopic
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    part_number: Schema.Attribute.Integer & Schema.Attribute.Required;
    preparation_time_seconds: Schema.Attribute.Integer &
...
export interface ApiTelegramAuthCodeTelegramAuthCode
  extends Struct.CollectionTypeSchema {
  collectionName: 'telegram_auth_codes';
  info: {
    displayName: 'Telegram Auth Code';
    pluralName: 'telegram-auth-codes';
    singularName: 'telegram-auth-code';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    telegram_id: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTestAttemptTestAttempt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    band_score: Schema.Attribute.Decimal;
    completed_at: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    writing_submissions: Schema.Attribute.Relation<
      'oneToMany',
      'api::writing-submission.writing-submission'
    >;
  };
}
...
export interface ApiTestProgressTestProgress
  ...
  info: {
    ...
    pluralName: 'test-progresses';
    singularName: 'test-progress';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    answers_snapshot: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    current_question: Schema.Attribute.Integer;
    current_section: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::test-progress.test-progress'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    test_attempt: Schema.Attribute.Relation<
      ...
      'api::test-attempt.test-attempt'
    >;
    time_remaining_seconds: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTestTest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    writing_tasks: Schema.Attribute.Relation<
      'oneToMany',
      'api::writing-task.writing-task'
    >;
  };
}
...
export interface ApiUserAnswerUserAnswer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answered_at: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    points_earned: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiWritingSubmissionWritingSubmission
  extends Struct.CollectionTypeSchema {
  collectionName: 'writing_submissions';
  info: {
    displayName: 'Writing Submission';
    pluralName: 'writing-submissions';
    singularName: 'writing-submission';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    coherence_score: Schema.Attribute.Decimal;
    content: Schema.Attribute.RichText & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    word_count: Schema.Attribute.Integer;
    writing_task: Schema.Attribute.Relation<
      'manyToOne',
      'api::writing-task.writing-task'
    >;
  };
...
export interface ApiWritingTaskWritingTask extends Struct.CollectionTypeSchema {
  collectionName: 'writing_tasks';
  info: {
    displayName: 'Writing Task';
    pluralName: 'writing-tasks';
    singularName: 'writing-task';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    min_words: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<150>;
    prompt: Schema.Attribute.RichText & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    sample_answer: Schema.Attribute.RichText;
    task_number: Schema.Attribute.Integer & Schema.Attribute.Required;
    task_type: Schema.Attribute.Enumeration<['report', 'essay']>;
    test: Schema.Attribute.Relation<'manyToOne', 'api::test.test'>;
    time_limit: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mock_test_expires_at: Schema.Attribute.DateTime;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    target_band_score: Schema.Attribute.Decimal;
