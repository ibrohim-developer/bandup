...
> = {
  ...
  "white-on-black": { bg: "#0a0a0a", bgAlt: "#1a1a1a", text: "#ffffff", textMuted: "#a3a3a3", border: "#333333", highlight: { bg: "#fef08a", color: "#111827" }, noteHighlight: { bg: "#bfdbfe", color: "#111827" } },
