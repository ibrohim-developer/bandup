...
interface SpeakingRecommendationsProps {
  actions: string[];
}
...
export function SpeakingRecommendations({
  actions,
}: SpeakingRecommendationsProps) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Based on your performance, here are personalized actions to improve
          your score:
        </p>
      </div>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Try another speaking topic to keep improving your score.
            </p>
          </div>
